...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xFF49a6a2 );
  static const Color secondary = Color(0xffffffff);
  static const Color text = Color(0xff6bd6d1);
  ...
  static const Color grad1Color = Color(0xFF49a6a2 );
  ...
  static const Color red = Color(0xFF49a6a2 );
