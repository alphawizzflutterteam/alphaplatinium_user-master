...
import 'package:alphasilver_multivendor/Helper/PushNotificationService.dart';
...
import 'package:alphasilver_multivendor/Screen/Favorite.dart';
import 'package:alphasilver_multivendor/Screen/Login.dart';
import 'package:alphasilver_multivendor/Screen/MyProfile.dart';
import 'package:alphasilver_multivendor/Screen/Product_Detail.dart';
  ...
  AppBar _getAppBar() {
    ...
    return AppBar(
      ...
      actions: <Widget>[
        ...
        _selBottom == 0 ? Container() : IconButton(
